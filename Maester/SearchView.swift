    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            VStack {
                ...
                HStack {
                    SearchSuggestion(book: $state.book.tags, value: $state.search_keyword, search_type: $state.search_type, searching_type: SearchType.Tag)
                    Spacer()
                }
            }
            ...
            VStack {
                ...
                HStack {
                    SearchSuggestion(book: $state.book.categories, value: $state.search_keyword, search_type: $state.search_type, searching_type: SearchType.Category)
                    Spacer()
                }
            }
